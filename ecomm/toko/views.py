...
from .models import User,ProdukItem, OrderProdukItem, Order, AlamatPengiriman, Payment

class LandingView(generic.View):
    def get(self,request):
        return render(self.request,'landing.html')

class ProfilView(generic.View):
    def get(self,request):
        user=User.objects.all()
        context ={
            'user':user,
        }
        return render(self.request,'profil.html',context)



# def kategori_produk(request,kategori=None):
#     selected_kategori = kategori
#     Produk_list = ProdukItem.objects.all()
#     # Kategori_list = ['Shirts','Sport wears','Outwears']
#     produk_list = Produk_list.filter(kategori=selected_kategori)
#     context = {
...
class KategoriProdukView(generic.ListView):
    def get (self,*args, **kwargs):
        produk_list = ProdukItem.objects.filter(kategori=kwargs['kategori'])
        context = {
        'produk_list': produk_list,
        }
        return render(self.request, 'kategori.html')
